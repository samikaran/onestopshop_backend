...
class ConfigSettings(models.Model):
    ...
    service_fee_flat_rate = models.DecimalField(
        default=0.7, max_digits=12, decimal_places=2, help_text="NOTE: Add the amount you want to charge as service fee e.g $2.30")
...
class Tax(models.Model):
    ...
    rate = models.IntegerField(
        default=13, help_text="Numbers added here are in percentage (13 = 13%)")
