...
# Models
from ecommerce.models import Product, Category, Brand, Cart, User, CartOrder, CartOrderItem, Coupon, Notification, Review
from addons.models import ConfigSettings, Tax

# Serializers
from ecommerce.serializers import ProductSerializer, CategorySerializer, BrandSerializer, CartSerializer, CartOrderSerializer, CartOrderItemSerializer, CouponSerializer, ReviewSerializer
...
class ProductDetailView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        return Product.objects.get(slug=slug, id=id)
